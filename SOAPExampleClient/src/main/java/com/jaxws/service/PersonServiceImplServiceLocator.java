...
public class PersonServiceImplServiceLocator extends org.apache.axis.client.Service implements com.jaxws.service.PersonServiceImplService {
    ...
    public com.jaxws.service.PersonServiceImpl getPersonServiceImpl() throws javax.xml.rpc.ServiceException {
    ...
    public com.jaxws.service.PersonServiceImpl getPersonServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.jaxws.service.PersonServiceImplSoapBindingStub _stub = new com.jaxws.service.PersonServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.jaxws.service.PersonServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.jaxws.service.PersonServiceImplSoapBindingStub _stub = new com.jaxws.service.PersonServiceImplSoapBindingStub(new java.net.URL(PersonServiceImpl_address), this);
                _stub.setPortName(getPersonServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.jaxws.com", "PersonServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.jaxws.com", "PersonServiceImpl"));
        }
